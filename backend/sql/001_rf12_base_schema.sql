...
CREATE TABLE IF NOT EXISTS materias_prerrequisito (
  ...
  prerrequisito_id BIGINT NOT NULL REFERENCES materias(id) ON DELETE CASCADE,
  nota TEXT,
...
CREATE TABLE IF NOT EXISTS calificaciones (
  ...
  CONSTRAINT uq_calificacion_por_curso UNIQUE (curso_id, estudiante_id)
);

CREATE INDEX IF NOT EXISTS idx_materias_carrera_semestre ON materias (carrera_id, semestre);
CREATE INDEX IF NOT EXISTS idx_cursos_docente ON cursos (docente_id, gestion, periodo);
CREATE INDEX IF NOT EXISTS idx_curso_estudiantes_estudiante ON curso_estudiantes (estudiante_id, estado);
CREATE INDEX IF NOT EXISTS idx_calificaciones_curso_estudiante ON calificaciones (curso_id, estudiante_id);
